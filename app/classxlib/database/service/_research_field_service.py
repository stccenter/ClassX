...
class ResearchFieldService(BaseService):
    ...
    def update_label_map(self,
                         research_id:int,
                         new_label_map:dict) -> ResearchField:
        ...
        return self.repo.update_label_map_by_id(research_field_id=research_id,
                                                new_label_map=new_label_map)

    def update_field_data(self,
                          research_id:int,
                          new_field_data:dict) -> ResearchField:
        ...
        return self.repo.update_field_data_by_id(research_field_id=research_id,
                                                 new_field_data=new_field_data)

    def update_metadata_map(self,
                           research_id:int,
                           new_metadata_map:dict) -> ResearchField:
        ...
        return self.repo.update_metadata_map_by_id(research_field_id=research_id,
                                                   new_metadata_map=new_metadata_map)

    def update_protocols(self,
                         research_id:int,
                         new_protocols:dict) -> ResearchField:
        ...
        return self.repo.update_protocols_by_id(research_field_id=research_id,
