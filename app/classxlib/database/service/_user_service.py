...
class UserService(BaseService):
    ...
    def update_research_fields(self, user_id:int, research_field_id_list:list[int], append:bool=True):
        ...
        """
        return self.repo.update_research_fields_by_id(user_id=user_id,
    ...
    def get_all_user_except(self, username:str) -> list[User]:
        ...
        return self.repo.get_all_except_username(username=username,
