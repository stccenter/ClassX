...
class SegmentImage(BaseModel): # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, user_id,
                 ...
                 crop_image_id, research_id,
                 name, segment_path,
                 marked_image_path, last_modified_date,
                 param1, param2,
                 param3, segment_method,
                 region_merge_method, region_merge_threshold,
                 small_rem_method, small_rem_threshold,
                 light_method,contrast_method,
                 color_method,color_clusters,
                 crop_size):
