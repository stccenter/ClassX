...
def create_label_image_table(metadata:MetaData):
    ...
    labeled_images_table = Table(
        ...
        Column("training_file_id", Integer,ForeignKey("training_files.id"), nullable=False),
        Column("segment_image_id", Integer,ForeignKey("segment_images.id"), nullable=False),
