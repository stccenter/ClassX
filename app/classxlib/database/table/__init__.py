...
__all__ = ['create_user_table','create_user_level_table',
           'create_user_friends_table', 'create_user_research_fields_table',
           'create_original_image_table','create_crop_image_table',
           'create_segment_image_table','create_label_image_table',
           'create_research_field_table','create_training_file_table']