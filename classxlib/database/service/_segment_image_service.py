...
class SegmentImageService(BaseService):
    ...
    def get_user_image(
        self, segment_image_id: int, user_id: int, default_id: int = None
    ) -> SegmentImage:
        ...
        return self.repo.get_first_by_user_id_args(
            user_id=user_id, default_id=default_id, id=segment_image_id
        )
    ...
    def get_user_images_from_parent(
        ...
        return self.repo.get_all_by_user_id_args(
            user_id=user_id, default_id=default_id, crop_image_id=crop_image_id
        )
