...
class TrainingFileService(BaseService):
    ...
    def get_user_file(
        self, training_file_id: int, user_id: int, default_id: int = None
    ) -> TrainingFile:
        ...
        return self.repo.get_first_by_user_id_args(
            user_id=user_id, default_id=default_id, id=training_file_id
        )

    def get_user_research_files(
    ...
    def get_user_file_by_name(
        self, training_file_name: str, user_id: int, default_id: int = None
    ) -> TrainingFile:
        ...
        return self.repo.get_first_by_user_id_args(
            user_id=user_id, default_id=default_id, file_name=training_file_name
        )

    def update_label_count(
        ...
        return self.repo.update_label_count_by_id(
            training_file_id=training_file_id, new_label_count=new_label_count
        )
