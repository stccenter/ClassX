...
class LabelImageService(BaseService):
    ...
    def get_image_from_parents(
        self, segment_image_id: int, training_file_id: int
    ) -> LabelImage:
        ...
        return self.repo.get_first_by_args(
            segment_image_id=segment_image_id, training_file_id=training_file_id
        )

    def update_last_modified(
        self, segment_image_id: int, training_file_id: int, new_date: datetime
    ) -> LabelImage:
        ...
        return self.repo.update_last_modified_by_training_id_segment_id(
