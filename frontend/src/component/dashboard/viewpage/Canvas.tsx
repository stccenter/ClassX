...
export default function Canvas(props) {
    ...
    useEffect(() => {
        ...
        let image = new Image();
        image.src = `${import.meta.env.VITE_CDN_URL}/static/${props.originalImage.thumbnail_path}`;
        // image.src = `http://localhost:5000/static/${props.originalImage.thumbnail_path}`;
